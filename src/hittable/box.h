#ifndef RADIANT_BOX_H
#define RADIANT_BOX_H
...
public:
    ...
    box(const point &p0, const point &p1, const shared_ptr<material> &ptr);
...
box::box(const point &p0, const point &p1, const shared_ptr<material> &ptr) {
    box_min = p0;
    box_max = p1;
