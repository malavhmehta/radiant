#ifndef RADIANT_HITTABLE_H
#define RADIANT_HITTABLE_H
...
public:
    ...
    virtual bool
    bounding_box(double time0, double time1, aabb &output_box) const = 0;
};
...
public:
    ...
    translate(shared_ptr<hittable> p, const vec &displacement)
...
bool
translate::bounding_box(double time0, double time1, aabb &output_box) const {
...
bool
rotate_y::hit(const ray &r, double t_min, double t_max, hit_record &rec) const {
